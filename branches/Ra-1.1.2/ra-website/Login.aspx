...
<asp:Content 
    ...
    <ra:Panel
        ...
        ID="pnlLogin"
        Visible="false" 
        style="border:solid 1px #aaa;padding:5px;width:300px;">
    ...
    <ra:Panel 
        ...
        style="background-color:Yellow;border:solid 1px #333;padding:5px;">
    ...
    <ra:Panel
	    ...
	    ID="pnlRegister"
	    Visible="false"
	    style="border:solid 1px #aaa;width:350px;padding:5px;"> 
    ...
    <ra:Panel 
        ...
        ID="pnlProfile" 
	    Visible="false"
	    style="border:solid 1px #aaa;padding:5px;width:400px;height:300px;">
