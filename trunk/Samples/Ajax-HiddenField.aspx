...
<asp:Content 
    ...
    <p>
        ...
        byt having "normal" WebControls like Button, CheckBox and HiddenFields on your page and then
    ...
    <p>
        ...
        in a very specific set of conditions. Then you would have to add up <strong>15 different update 
        panels</strong> which probably have at least a handful of <em>trigger collections</em> themselves.
    ...
    <p>
        ...
        *IMPOSSIBLE* to do in ASP.NET AJAX without resorting to "Custom JavaScript" since in the 
    ...
    <p>
        ...
        of that code this is <strong>3 lines of code</strong>. Still in ASP.NET AJAX this is impossible
