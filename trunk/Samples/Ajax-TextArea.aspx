...
<asp:Content 
    ...
    <p>
        ...
        classic "school example" of such an "is a relationship" is best constructed utilizing the sample of
        a Rectangle and a Square. For most people inheriting the <em>Square class</em> from the 
    ...
    <p>
        ...
        not really much Ra-Ajax can do in regards to "the Page LSP problem".
    </p>
    <p>
        ...
        see this problem manifested in "classic ASP.NET" by dragging a <em>System.Web.UI.WebControls.TextBox</em>
        onto your page, and without changing its TextMode setting its Rows and Columns property to "some value".
    </p>
    <p>
    ...
    <p>
        ...
        at least in those places where we *have* actual control. One example of such is the 
