...
public partial class Wiki : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (url == null)
        {
            // Finding default article (landing page)
            _article = Article.FindOne(Expression.Eq("Url", "default"));
        }
        else
        ...
        if (!IsPostBack)
        {
            ...
            if (_article == null)
            {
                ...
                // don't allow editing of articles for users not logged in
...
<p><em>Last changed; {0}</em></p>",
    ...
    protected void tab_ActiveTabViewChanged(object sender, EventArgs e)
    {
        ...
        else if (tab.ActiveTabViewIndex == 1)
        {
            ...
            {
                // Setting admin specific widgets to visible
